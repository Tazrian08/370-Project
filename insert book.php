...
if (
	...
	$pn=$_POST['publisher_n'];
	$publisher_n = mysqli_real_escape_string($conn, $pn);
	...
	$pub="Select * from Publication Where Publisher_ID='$publisher_id'";
	$pubr=mysqli_query($conn, $pub);
	if (mysqli_num_rows($pubr) === 0) {
		$pin="INSERT INTO Publication VALUES ('$publisher_id','$publisher_n')";
		$pin1=mysqli_query($conn, $pin);
	}
